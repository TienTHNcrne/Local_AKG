...
import KH from "../Home/Climate/KH/KH.jsx";
import DL from "../Home/Climate/DL/DL.jsx";
import TQ from "../Home/Climate/TQ/TQ.jsx";
        ...
        <div className={styles.container}>
            ...
            <div className={styles.title}>
                <div className={styles.titleContent}>
                    ...
                    <h1>Bốn vùng khí hậu – Một bản sắc An Giang</h1>
            ...
            {/* ===== GENERAL CLIMATE SECTION ===== */}
            <div className={styles.mainContent}>
                {/* Area selector */}
                <div className={styles.areaSelector}>
                    <div className={styles.selectorHeader}>
                        <h2>Chọn vùng khí hậu</h2>
                        <p>Khám phá đặc điểm khí hậu từng vùng</p>
                    </div>
                ...
                <div className={styles.areaClimate}>
                                    ...
                                    <div className={styles.areaName}>
                                        <div className={styles.areaTitleRow}>
                                            ...
                                            <div className={styles.areaRatio}>
                                                Chiếm {selectedArea.ratioArea}%
                                                diện tích
                                            </div>
                                        </div>
                                        <p className={styles.areaSubtitle}>
                                            Vùng khí hậu đặc trưng của An Giang
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className={styles.infoTypeSelector}>
                    ...
                    <div className={styles.dynamicContent}>
                        <div className={styles.contentWrapper}>
                            ...
                            {typeInfo === "TQ" && (
                                <TQ selectedArea={selectedArea} />
                            )}
                            {typeInfo === "DL" && (
                                <DL selectedArea={selectedArea} />
                            )}
                        </div>
                    </div>
                </div>
